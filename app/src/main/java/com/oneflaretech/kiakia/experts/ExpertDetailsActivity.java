...
import com.oneflaretech.kiakia.ReviewsActivity;
import com.oneflaretech.kiakia.activities.BaseActivity;
import com.oneflaretech.kiakia.activities.ShowImageActivity;
...
//        }
    ...
    private void submitReview(final Dialog dialog) {
        ...
        Bridge.post(com.oneflaretech.kiakia.utils.Request.api + "/reviews/add")
                .body(form)
    ...
    public void sendreporttoServer(final String text, final RelativeLayout dialogview) {
        ...
        Bridge.post(com.oneflaretech.kiakia.utils.Request.api + "/experts/report")
                .body(form)
                .asString(new ResponseConvertCallback<String>() {
                    @Override
                    public void onResponse(@NonNull com.afollestad.bridge.Response response, @Nullable String object, @Nullable BridgeException e) {
