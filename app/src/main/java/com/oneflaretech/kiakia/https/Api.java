...
public interface Api {
    ...
    @FormUrlEncoded
    @POST("password/change/new")
    Observable<ResponseObjectModel> changePasswordNew(@Field("token") String token, @Field("new_password") String newPassword);

    @FormUrlEncoded
    @POST("password/forgot")
    Observable<ResponseObjectModel> forgotPassword(@Field("email") String email);

    @FormUrlEncoded
    @POST("verify/token")
    Observable<ResponseObjectModel> verifyToken(@Field("email") String email, @Field("code") String token);
